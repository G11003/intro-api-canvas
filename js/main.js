...
function draw_equilatero() {
  const canvas = document.getElementById("canvas_equilatero");
  if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
...
function draw_bezier2() {
  const canvas = document.getElementById("canvas_bezier2");
  if (canvas.getContext) {
    const ctx = canvas.getContext("2d");
...
function draw_bezier3() {
  const canvas = document.getElementById("canvas_bezier3");
  if (canvas.getContext) {
    const ctx = canvas.getContext("2d");
...
function draw_comb() {
  const canvas = document.getElementById("canvas_comb");
  if (canvas.getContext) {
    const ctx = canvas.getContext("2d");
